...
//-NoteRepository is just a normal class - used as a abstraction layer
//      between the ViewModel and the Room-so the VM doesn't have to worry
...
//      to its fields,we need to pass values to its ctor instead
//      -then doInBackGround() the db operations
